      ...
      >
          ...
          <div className='slider-core'>
              ...
              <div className='text-area-padding'>
                  <p className='title-section link'>
                    <a className='px-2 py-1'>Fastfill – Web Service</a>
                  </p>
                  <p className='subtitle-section'><a className='px-2 py-1'>Fastfill – พิมพ์เอกสารราชการเป็นภาษาอังกฤษ ง่าย สะดวก รวดเร็ว</a></p>
              </div>
          </div>        
        </SwiperSlide> 
        ...
        <SwiperSlide>        
          <div className='slider-core'>
              ...
              <div className='text-area-padding'>
                  <p className='title-section link'>
                    <a className='px-2 py-1'>Fastfill</a>
                  </p>
                  <p className='subtitle-section'><a className='px-2 py-1'>Fastfill – พิมพ์เอกสารราชการเป็นภาษาอังกฤษ ง่าย สะดวก รวดเร็ว</a></p>
              </div>
          </div>        
